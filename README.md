...
|---|:---:|:---:|:---:|:---:|:---:|
| **Source-Only** | None | $1.0\times$ | 43.5% | 60.5% (Stable floor) | 0.284 |
| **TENT** (ICLR '21) | Yes | $2.4\times$ | 20.2% | Collapsed (89.2%) | 0.312 |
| **CoTTA** (CVPR '22) | Yes | $3.2\times$ | 16.3% | Drifts (68.7%) | 0.225 |
| **BCA+** (CVPR '25) | None | $1.1\times$ | 14.8% | Invariant (37.9%) | 0.086 |
| **AS-FiLM (Ours)** | **None** | **$1.1\times$** | **15.4%** | **Invariant ($P_t \equiv 0$)** | **0.091** |
